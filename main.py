...
# Function to calculate the Closest-Pair-Distance for a trajectory
...
def calculate_closest_pair_distances(trajectories):
    ...
    for traj in trajectories:
        closest_distance = closest_pair_distance(traj.points)
...
def dtw_distance(trajectory1, trajectory2):
    ...
    distance_matrix = cdist(trajectory1_points, trajectory2_points, euclidean)
...
def calculate_dtw_distances(trajectories):
    ...
    for i in range(num_trajectories):
        for j in range(i, num_trajectories):
            dtw_dist = dtw_distance(trajectories[i].points, trajectories[j].points)
